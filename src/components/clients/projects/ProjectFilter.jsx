...
const ProjectFilter = ({onApplyFilters, onResetFilters}) => {
                ...
                <form onSubmit={handleSubmit} className= "p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
                        <div>
                            ...
                            className= "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1d4370] focus:border-transparent">
                        ...
                        <div>
                            <label htmlFor= "prixMin" className= "block text-sm font-meduim text-gray-700 mb-1">
                                Prix min (DH)
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label htmlFor="prixMax" className="block text-sm font-semibold text-gray-700 mb-1">
                                Prix max (DH)
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label htmlFor="surfaceMin" className='block text-sm font-semibold text-gray-700 mb-1'>
                                Surface min (m²)
                            </label>
                            <input 
                                type="number"
